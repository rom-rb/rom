...
require 'data_mapper/relation_registry/node/relation'
require 'data_mapper/relation_registry/node/relation/base'
require 'data_mapper/relation_registry/node/aliasing'
