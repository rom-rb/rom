RSpec.describe ROM::Plugins::Schema::Timestamps do
  ...
  it 'adds timestamp attributes' do
    ts_attribute = -> name { ROM::Schema::Attribute.new(ROM::Types::Time.meta(name: name, source: relation)) }
  ...
  it 'supports custom types' do
    ...
    dt_attribute = -> name { ROM::Schema::Attribute.new(ROM::Types::Date.meta(name: name, source: relation)) }
