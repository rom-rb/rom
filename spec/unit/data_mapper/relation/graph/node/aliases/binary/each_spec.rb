...
describe Relation::Graph::Node::Aliases::Binary, '#each' do
  subject { object.each { |field, aliased_field| yields[field] = aliased_field } }

  let(:yields) { {} }

  let(:songs) { Relation::Graph::Node::Aliases::Unary.new(songs_entries, songs_aliases) }
  ...
  let(:song_tags) { Relation::Graph::Node::Aliases::Unary.new(song_tags_entries, song_tags_aliases) }
  ...
  let(:tags) { Relation::Graph::Node::Aliases::Unary.new(tags_entries, tags_aliases) }
  ...
  let(:infos) { Relation::Graph::Node::Aliases::Unary.new(infos_entries, infos_aliases) }
  ...
  let(:song_comments) { Relation::Graph::Node::Aliases::Unary.new(song_comments_entries, song_comments_aliases) }
  ...
  let(:comments) { Relation::Graph::Node::Aliases::Unary.new(comments_entries, comments_aliases) }
...
describe Relation::Graph::Node::Aliases::Binary do
